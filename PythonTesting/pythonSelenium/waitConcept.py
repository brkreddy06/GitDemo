...
#it is Global wait
#1.5 second to reach next page - execution will resume in 1.5 seconds not not wait until 5 secs
#if object does not show up at all then max time your test waits for 5 sec
